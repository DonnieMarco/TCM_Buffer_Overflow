...
# -m = module which is the module found in line 4 that was attache to vulnserver that had no protections = essfunc.dll
# -s "\xff\xe4" is the hex code generated by nasm for the JMP ESP
